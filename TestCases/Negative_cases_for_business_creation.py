...
class Test_Login:
    ...
    test_data = [
        ...
        ("Homeies dapping", "3", "", "Please enter valid company name and description"), # Missing description
       # ("Homeies dapping", "", "", "Please enter valid company name and description"), # Missing category and description
        ...
        ("", "", "", "Please enter valid company name and description"), # Missing category, business and description
    ...
    def test_verify_that_the_user_get_a_correct_error_message_with_empty_fields(self, setup, business_name, category, description, error_message ):
        try:
